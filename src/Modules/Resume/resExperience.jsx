  ...
  return (
    <section>
      ...
      <article>
        ...
        <ul>
          <li>
            Designed promotional materials, social media posts, and in-store
            event signage
          </li>
          <li>
            Transformed store layout to improve customer flow and product
            accessibility
          </li>
          <li>
            Spearheaded the hiring, training, supervision, and scheduling of
            associates and community volunteers
          </li>
          <li>
            Coordinated pickup appointments, processing, pricing, and
            merchandising of all incoming donations
          </li>
          <li>
